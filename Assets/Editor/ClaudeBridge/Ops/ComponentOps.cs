...
namespace Editor.ClaudeBridge.Ops
{
    /// <summary>
    ...
    internal static class ValueCodec
    {
        ...
        public static string Encode(object value, Type declaredType)
        {
            ...
            if (value is UnityEngine.Object uo)
            {
                ...
                return JsonUtility.ToJson(new ObjectRef { assetPath = assetPath, instanceId = uo.GetEntityId() });
            }
        ...
        [Serializable]
        class ObjectRef { public string assetPath; public EntityId instanceId; }
    }
}
